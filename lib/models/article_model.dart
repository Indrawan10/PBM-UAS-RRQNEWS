...
class Article extends Equatable {
  ...
  static List<Article> articles = [
    Article(
      ...
      category: 'Politics',
      views: 1204,
      imageUrl: 'https://i.ytimg.com/vi/pvChBcX1B8s/maxresdefault.jpg',
    ...
    Article(
      ...
      category: 'Politics',
      views: 1204,
      imageUrl: 'https://i.ytimg.com/vi/ukRh0G_j2Jk/maxresdefault.jpg',
    ...
    Article(
      ...
      category: 'Politics',
      views: 1204,
      imageUrl: 'https://i.ytimg.com/vi/u1w-bomiBjU/maxresdefault.jpg',
    ...
    Article(
      ...
      category: 'Politics',
      views: 1204,
      imageUrl: 'https://i.ytimg.com/vi/9mAO-n0TuO4/maxresdefault.jpg',
